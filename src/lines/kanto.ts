...
// kanto 지역 노선
export const kanto: OperatorData = {
  "JR東日本": [
    {
        id: "11302",
        nameKo: "야마노테선",
  ...
  "宇都宮ライトレール": [
    {
      id: "99345",
      nameKo: "우쓰노미야하가라이토레루선",
      nameJp: "芳賀・宇都宮LRT",
      nameKana: "ウツノミヤハガライトレールセン",
      color: "#D35400",
      stations: [
        {
          name: "宇都宮駅東口",
